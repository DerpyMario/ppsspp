...
// The developer PSAR key. A 1.00-era updater's DATA.PSAR is encrypted with this rather than with
// any of the retail tags, which is why one decrypted to nothing at all before.
static const u32 g_keyDEVPSAR[] = {
