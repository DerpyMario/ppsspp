...
static const CommandLineParam g_autoParams[] = {
	...
	{POFF(nand), CmdParamType::String, "nand", '\0', "NAND root directory (contains flash0, flash1) - where --vsh boots from"},
	...
	{POFF(bootVSH), CmdParamType::Bool, "vsh", '\0', "Boot the VSH (requires a firmware in the NAND directory - dumped from a PSP, or installed from an updater)"},
